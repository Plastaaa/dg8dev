            ...
            <div>
                <div className='flex flex-wrap'>
                    ...
                    <div className='w-10/12 pl-4 pt-4'>
                        <button onClick={this.stateChange} type="button" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-800 dark:focus:ring-red-800">
