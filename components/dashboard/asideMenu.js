        ...
        return(
            <li>
                <a href="/dashboard/calendrier" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 hover:rounded-xl  dark:hover:bg-gray-700">
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Calendrier</span>
                </a>
            </li>       
        )
    }else{
    ...
    render(){
        ...
        return (
            <div className="h-screen w-full">
                <div className="p-6">
                    <div className="bg-gray-50 dark:bg-gray-900 border shadow-xl border-2 rounded-xl">
                        <ul>
                            <li>
                            ...
                            <li>
                                <a onClick={this.stateDisconnect} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 hover:rounded-xl dark:hover:bg-gray-700">
                                    <span className="flex-1 whitespace-nowrap font-bold text-center">Déconnexion</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="overflow-y-auto py-4 px-3 bg-gray-100 rounded dark:bg-gray-800">
                    <ul className="space-y-2">
                        <li>
                            <a href="/dashboard/dash" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg aria-hidden="true" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
                        ...
                        <li>
                            <a href="/dashboard/camping-car" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
                                <span className="flex-1 ml-3 whitespace-nowrap">Camping-cars</span>
                                {
                        ...
                        <li>
                            <a href="/dashboard/dash" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap line-through">Utilisateurs</span>
                            </a>
                        </li>
                        <li>
                            <a href="/dashboard/dash" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <li>
                            <a onClick={this.stateDisconnect} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
