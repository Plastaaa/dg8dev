    ...
    render(){
        ...
        <div>
            <div class="flex h-screen">
                <div class="px-4 py-2 bg-gray-200 bg-gray-300 lg:w-1/4">
                    ...
                    <div class="hidden lg:block">
                        <div class="my-2 mb-6">
                            <h1 class="text-2xl font-bold text-black">Dashboard - DG8CC</h1>
                        </div>
                        <ul>
                            <li class="mb-2 rounded hover:shadow hover:bg-white">
                                <a href="#" class="inline-block w-full h-full px-3 py-2 font-bold text-black">
                                    Accueil
                                </a>
                            </li>
                            <li class="mb-2 rounded hover:shadow hover:bg-white">
                            ...
                            <li class="mb-2 rounded hover:shadow hover:bg-gray-500 bg-gray-700">
                        ...
                        <div class="grid gap-4 lg:grid-cols-3">
                            <div class="flex items-center px-4 py-6 bg-white rounded-md shadow-md">
                                ...
                                <div class="mx-4">
                                    ...
                                    <div class="text-gray-500">Camping-cars disponibles</div>
                                </div>
                            </div>
                            <div class="flex items-center px-4 py-6 bg-white rounded-md shadow-md">
                                <div class="p-3 bg-red-600 rounded">
